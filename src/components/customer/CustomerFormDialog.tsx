...
import { Customer, LoanType, LoanStatus, HomeType, CaseType } from '@/types';
...
export default function CustomerFormDialog({
  ...
  const showDSAField = role !== 'connector';
        ...
        <form onSubmit={handleSubmit} className="space-y-6 mt-4">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              {renderField('personalEmail', 'Personal Email', formData.personalEmail, (v) => setFormData({ ...formData, personalEmail: v }), {
